...
class AppKernel extends Kernel {
    ...
    public function registerBundles() {
        $bundles = array(
            ...
            new AppBundle\AppBundle(),
            // Samples
            new Samples\IndexBundle\SamplesIndexBundle(),
            new Samples\CompanyBundle\SamplesCompanyBundle(),
            new Samples\ProgramadoresBundle\SamplesProgramadoresBundle(),
            new Samples\EscuelaBundle\SamplesEscuelaBundle(),
            new Samples\CibercafeBundle\SamplesCibercafeBundle(),
            new Samples\EscolaBundle\SamplesEscolaBundle(),
            new Samples\AvaliacaoDesempenhoBundle\SamplesAvaliacaoDesempenhoBundle(),
            new Samples\PropinasEstudiantisBundle\SamplesPropinasEstudiantisBundle(),
            new Samples\FarmaciaBundle\SamplesFarmaciaBundle(),
            new Samples\StockViveresBundle\SamplesStockViveresBundle(),
        );

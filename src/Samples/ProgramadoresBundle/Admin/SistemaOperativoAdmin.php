...
class SistemaOperativoAdmin extends Admin {

    protected $baseRouteName = 'samples_programadoresadmin_sistema_operativo';
	
    protected $baseRoutePattern = 'sistema-operativo';

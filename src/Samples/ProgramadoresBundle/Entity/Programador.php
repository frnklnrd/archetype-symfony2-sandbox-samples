...
/**
 * @ORM\Entity
 * @ORM\Table(name="samples_programadores__programador",
 *           uniqueConstraints={
 ...
 *                             })
 * @ORM\Entity(repositoryClass="\Samples\ProgramadoresBundle\Manager\ProgramadorRepository")
...
class Programador {
     ...
     * @ORM\JoinTable(name="samples_programadores__lenguajes_preferidos", 
    ...
    public function getImagePreview() { // url donde va a estar la foto para acceder x la web
        return null === $this->foto_path ? null : "<img width='50px' src='/".$this->getUploadDir() . '/' . $this->foto_path."'>";
    }
     ...
     *
     * @param \Samples\ProgramadoresBundle\Entity\SistemaOperativo $sistemaOperativo
     * @return Programador
     */
    public function setSistemaOperativo(\Samples\ProgramadoresBundle\Entity\SistemaOperativo $sistemaOperativo = null) {
     ...
     *
     * @return \Samples\ProgramadoresBundle\Entity\SistemaOperativo 
     */
     ...
     *
     * @param \Samples\ProgramadoresBundle\Entity\LenguajeProgramacion $lenguajesProgramacion
     * @return Programador
     */
    public function addLenguajesProgramacion(\Samples\ProgramadoresBundle\Entity\LenguajeProgramacion $lenguajesProgramacion) {
     ...
     * @param \Samples\ProgramadoresBundle\Entity\LenguajeProgramacion $lenguajesProgramacion
     */
    public function removeLenguajesProgramacion(\Samples\ProgramadoresBundle\Entity\LenguajeProgramacion $lenguajesProgramacion) {
     ...
     * Add proyectos
     *
     * @param \Samples\ProgramadoresBundle\Entity\Proyecto $proyectos
     * @return Programador
     */
    public function addProyecto(\Samples\ProgramadoresBundle\Entity\Proyecto $proyectos) {
     ...
     * @param \Samples\ProgramadoresBundle\Entity\Proyecto $proyectos
     */
    public function removeProyecto(\Samples\ProgramadoresBundle\Entity\Proyecto $proyectos) {
